...
async def send_password_reset_email(email: str, reset_token: str, user_name: str = "User"):
    ...
    try:
        ...
        reset_link = f"https://aavana-workspace.preview.emergentagent.com/reset-password?token={reset_token}"
        ...
        <body>
            <div class="container">
                ...
                <div class="content">
                    ...
                    <p style="text-align: center; margin: 30px 0;">
                        <a href="https://aavana-workspace.preview.emergentagent.com" style="display: inline-block; background: #10b981; color: white; padding: 12px 30px; text-decoration: none; border-radius: 5px; font-weight: bold;">Login to Your Account</a>
                    </p>
