...
class Camera502DiagnosticTest:
    def __init__(self):
        ...
        self.backend_url = os.getenv('REACT_APP_BACKEND_URL', 'https://aavana-green-crm.preview.emergentagent.com')
    ...
    async def test_cors_configuration(self, session: aiohttp.ClientSession):
        ...
        cors_test = await self.test_endpoint(
            ...
            '/hrms/face-checkin',
            headers={
                'Origin': 'https://aavana-green-crm.preview.emergentagent.com',
